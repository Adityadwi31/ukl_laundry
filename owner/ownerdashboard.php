  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="../owner/ownerdashboard.php"><img src="../admin/assets/images/logo.svg" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="../owner/ownerdashboard.php"><img src="../admin/assets/images/logo-mini.svg" alt="logo" /></a>
      </div>
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="../owner/ownerdashboard.php">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <a class="navbar-brand brand-logo-mini" href="../owner/ownerdashboard.php"><img src="../admin/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
