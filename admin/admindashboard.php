  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="../admin/admindashboard.php"><img src="../admin/assets/images/logo.svg" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="../admin/admindashboard.php"><img src="../admin/assets/images/logo-mini.svg" alt="logo" /></a>
      </div>
      <ul class="nav">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <a class="navbar-brand brand-logo-mini" href="../admin/admindashboard.php"><img src="../admin/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0" style="color: #e0e00d;" ><?php
                        include "../login/koneksi.php";
                        $dt_member = mysqli_query($koneksi, "select * from member ");
                        $jumlah_member = mysqli_num_rows($dt_member);
                        echo $jumlah_member;
                        ?>
                        </h3>
                      </div>
                  ...
                  <h6 class="font-weight-normal">Jumlah Member</h6>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0" style="color: #d11121;"><?php
                        include "../login/koneksi.php";
                        $dt_user = mysqli_query($koneksi, "select * from user ");
                        $jumlah_user = mysqli_num_rows($dt_user);
                        echo $jumlah_user;
                        ?>
                        </h3>
                      </div>
                  ...
                  <h6 class="font-weight-normal">Jumlah User</h6>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0" style="color: #19b2bd;"><?php
                        include "../login/koneksi.php";
                        $dt_paket = mysqli_query($koneksi, "select * from paket ");
                        $jumlah_paket = mysqli_num_rows($dt_paket);
                        echo $jumlah_paket;
                        ?>
                        </h3>
                      </div>
                  ...
                  <h6 class="font-weight-normal ">Jumlah Paket Laundry</h6>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-9">
                      <div class="d-flex align-items-center align-self-start">
                        <h3 class="mb-0" style="color: #7a09d6; "><?php
                        include "../login/koneksi.php";
                        $dt_outlet = mysqli_query($koneksi, "select * from outlet ");
                        $jumlah_outlet = mysqli_num_rows($dt_outlet);
                        echo $jumlah_outlet;
                        ?>
                        </h3>
                      </div>
                  ...
                  <h6 class="font-weight-normal">Jumlah Outlet</h6>
                </div>
              </div>
            </div>
          </div>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      ?> <a href="ubah_proses.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" style="text-decoration: none; color: #c800ff">proses</a>
                                        <a href="ubah_selesai.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" style="text-decoration: none; color: #0abf34">selesai</a>
                                        <a href="ubah_diambil.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" style="text-decoration: none; color: #fbff00">diambil</a>
                                      <?php
                                      ...
                                      ?>
                                      <a href="hapus_histori.php?id_transaksi=<?= $data_transaksi['id_transaksi'] ?>" style="text-decoration: none; color: #ff0033">Hapus</a>
                                    </td>
                                  </tr>
                                <?php
                                }
