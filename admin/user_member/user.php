                            ...
                            <table class="table table-dark">
                              ...
                              <tbody>
                                ...
                                ?>
                                  ...
                                  <!-- form ubah -->
                                  <div class="modal fade" id="ubah_user<?php echo $data_user['id_user'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ...
                                          include "../../login/koneksi.php";
                                          $id = $data_user['id_user'];
                                          $qry_get_user = mysqli_query($koneksi, "select * from user where
                                          id_user = '$id'");
                                          ...
                                          <form action="proses_ubah_user.php" method="post">
                                            ...
                                            nama :
                                            <input type="text" name="nama" value="<?= $data_user['nama'] ?>" class="text-light form-control">
                                            username :
                                            <input type="text" name="username" value="<?= $data_user['username'] ?>" class="text-light form-control">
                                            Role :
                                            <?php
                                            $arr_role = array('admin' => 'admin', 'kasir' => 'kasir', 'owner' => 'owner');
                                            ?>
                                            <select name="role" class="text-light form-control">
                                              <option></option>
